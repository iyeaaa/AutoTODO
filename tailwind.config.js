...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'aurora-gradient': 'linear-gradient(135deg, #8B5CF6 0%, #3B82F6 50%, #EC4899 100%)',
        'aurora-dark': 'linear-gradient(135deg, #1E1B4B 0%, #312E81 50%, #581C87 100%)',
      ...
      boxShadow: {
        ...
        'hover-card': '0 20px 40px 0 rgba(31, 38, 135, 0.2)',
      },
      animation: {
